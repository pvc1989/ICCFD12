...
Figure \ref{fig:shu_osher} gives the solution of this problem at the final ($t=1.8$) moment and the viscosity distribution for each characteristic variables at all time steps.
\begin{figure}[H]
  \centering
